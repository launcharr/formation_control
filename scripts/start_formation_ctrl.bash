...
byobu new-session -d -s "$BYOBU_SESSION_NAME" "roslaunch -p $LOCAL_PORT formation_control formation_topside.launch local_simulation:=false local_address:=$LOCAL_IP local_port:=$ROS2UDP_PORT && bash -l"

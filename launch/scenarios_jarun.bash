    ...
    case $cmd in
        ...
        chg_form)
            ...
            if [ "$par1_en" = "true" ]; then
                ...
                formX=[0,6,3,-6,0,-3,-3,3,0];
                formY=[0,0,6,0,0,6,-6,-6,0];
            fi
        ...
        s1)
            ...
            # pocni snimat bag
            rosbag record /vehicle1/stateHat /vehicle2/stateHat /surface/position /FCEnable /FormPosRef /FormChange -o Scenario1 & 
            pid=$(echo $!)
            # upali regulator
            FC_enable true;
            change_form [0,6,3,-6,0,-3,-3,3,0] [0,0,6,0,0,6,-6,-6,0] 0 true false
            pause enter
        ...
        s2)
            ...
            pause "Pocni snimat?";
            # pocni snimat bag
            rosbag record /vehicle1/stateHat /vehicle2/stateHat /surface/position /FCEnable /FormPosRef /FormChange -o Scenario2 &
            pid=$(echo $!)
            # promijeni formaciju
        ...
        s3)
            ...
            pause "Pocni snimat?";
            # pocni snimat bag
            rosbag record /vehicle1/stateHat /vehicle2/stateHat /surface/position /FCEnable /FormPosRef /FormChange -o Scenario3 &
            pid=$(echo $!)
        ...
        ri)
            ...
            rosparam load $(rospack find formation_control)/config/config.yaml /surface;
            pause "Variables loaded?";
